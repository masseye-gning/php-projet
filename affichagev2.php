...
if(mysqli_connect_errno()){
	...
	echo "Messaged'erreur : ",mysqli_connect_error(); 
		...
		while($ligne = mysqli_fetch_assoc($resultats)){
			...
			<td>".$ligne['images']."</td>
			<td><a class='btn btn-light btn-sm' href='supprimer.php?var=" .$ligne['num']."'>supprimer</a></td>
			<td><a class='btn btn-light btn-sm'  href='show.php?var=" .$ligne['num']."'>show</a></td>
			<td><a class='btn btn-light btn-sm'  href='from_modifier.php?var=".$ligne['num']."'>modifier</a></td>";
			echo "</tr>";
		}
			echo "</table>";
			echo "<a class='btn btn-light btn-sm'  href='formulaire.html'>Inserer un autre produit</a>";
...
<div class="container text-center">
			<button type="button" class="btn btn-lg  m-2 p-2 pt-3 mb-3">
				<a class=' href="formulaire.html" class="text-white ">
